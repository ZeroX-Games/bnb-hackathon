  ...
  const loggedInView = (
    <>
      <div className="flex-container">
        ...
        <div>
          <button onClick={geUserData} className="card">
            Get User Public key, Private key, and Twitter Account info
          </button>
        </div>
        <div>
          <button onClick={toMainGamePage} className="card">
            Pass User Data and Navigate to Main Game Page
          </button>
        </div>
      </div>
      <div id="console" style={{ whiteSpace: 'pre-line', width: '500px' }}>
